		...
		<div class="container">
			<div class="row">
				<div class="col">
					...
					<form action="./processUpdateBook.jsp" name="newBook" method="post"
						enctype="multipart/form-data">
						<div class="form-group row text-left">
							<label for="bookId" class="col-sm-2 col-form-label"> <fmt:message
									key="bookId" />
							</label>
							<div class="col-sm-5">
								<input type="text" class="form-control" id="bookId"
									name="bookId" value='<%=rs.getString("b_id")%>'>
							</div>
						</div>
						<div class="form-group row text-left">
						...
						<div class="form-group row text-left">
							<label for="unitPrice" class="col-sm-2 col-form-label"><fmt:message
									key="unitPrice" /></label>
							<div class="col-sm-5">
								<input type="text" class="form-control" id="unitPrice"
									name="unitPrice" value='<%=rs.getString("b_unitPrice")%>'>
							</div>
						</div>
						<div class="form-group row text-left">
							<label for="author" class="col-sm-2 col-form-label"><fmt:message
									key="author" /></label>
							<div class="col-sm-5">
								<input type="text" class="form-control" id="author"
									name="author" value='<%=rs.getString("b_author")%>'>
							</div>
						</div>
						<div class="form-group row text-left">
							<label for="publisher" class="col-sm-2 col-form-label"><fmt:message
									key="publisher" /></label>
							<div class="col-sm-5">
								<input type="text" class="form-control" id="publisher"
									name="publisher" value='<%=rs.getString("b_publisher")%>'>
							</div>
						</div>
						<div class="form-group row text-left">
							<label for="releaseDate" class="col-sm-2 col-form-label"><fmt:message
									key="releaseDate" /></label>
							<div class="col-sm-5">
								<input type="text" class="form-control" id="releaseDate"
									name="releaseDate" value='<%=rs.getString("b_releaseDate")%>'>
							</div>
						</div>
						<div class="form-group row text-left">
							<label for="totalPages" class="col-sm-2 col-form-label"><fmt:message
									key="totalPages" /></label>
							<div class="col-sm-5">
								<input type="text" class="form-control" id="totalPages"
									name="totalPages" value='<%=rs.getString("b_totalPages")%>'>
							</div>
						</div>
						...
						<div class="form-group row text-left">
							...
							<div class="col-sm-5">
								<textarea class="form-control" id="exampleFormControlTextarea1"
									rows="3" name="description" value='<%=rs.getString("b_description")%>'></textarea>
							</div>
						</div>

						<div class="form-group row text-left">
							<label for="category" class="col-sm-2 col-form-label"><fmt:message
									key="category" /></label>
							<div class="col-sm-5">
								<input type="text" class="form-control" id="category"
									name="category" value='<%=rs.getString("b_category")%>'>
							</div>
						</div>
						<div class="form-group row text-left">
							<label for="unitsInStock" class="col-sm-2 col-form-label"><fmt:message
									key="unitsInStock" /></label>
							<div class="col-sm-5">
								<input type="text" class="form-control" id="unitsInStock"
									name="unitsInStock" value='<%=rs.getString("b_unitsInStock")%>'>
							</div>
						</div>
						<div class="form-group row text-left">
							<label for="inputPassword" class="col-sm-2 col-form-label"><fmt:message
						...
						<div class="form-group row text-left">
							<label for="bookImage" class="col-sm-3 col-form-label"><fmt:message
									key="bookImage" /></label>
							<div class="col-sm-5">
