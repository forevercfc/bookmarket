   ...
   <c:when test="${sessionId eq 'admin'}">
      <nav class="navbar navbar-expand-sm navbar-light bg-warning">
         <ul class="navbar-nav mr-auto">
            <li class="nav-item">
            <a class="nav-link" href='<c:url value="/Test/addBook.jsp"/>'>상품등록</a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href='<c:url value="/Test/editBook.jsp?edit=update"/>'>상품수정</a>
            </li>
            <li class="nav-item">
            <a class="nav-link"href='<c:url value="/Test/editBook.jsp?edit=delete"/>'>상품삭제</a>
            </li>
            <li class="nav-item">
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
 <a class="navbar-brand" href='<c:url value="/Test/Welcome.jsp"/>'>교보문고</a>
